-- =====================================================
-- COMBINED MIGRATION: Add always_show column to both RR and BR tables
-- =====================================================
...
-- =====================================================
-- UPDATE RR (Resultaträkning) always_show values
-- =====================================================
...
-- =====================================================
-- UPDATE BR (Balansräkning) always_show values
-- =====================================================
...
-- Verify RR updates
SELECT 'RR' as table_name, row_id, row_title, always_show 
FROM variable_mapping_rr 
WHERE row_id BETWEEN 240 AND 279 
ORDER BY row_id;

-- Verify BR updates  
SELECT 'BR' as table_name, row_id, row_title, always_show 
FROM variable_mapping_br 
WHERE row_id BETWEEN 310 AND 417 
ORDER BY row_id;

-- Summary counts
SELECT 'RR TRUE count' as description, COUNT(*) as count FROM variable_mapping_rr WHERE always_show = TRUE AND row_id BETWEEN 240 AND 279
UNION ALL
SELECT 'RR FALSE count' as description, COUNT(*) as count FROM variable_mapping_rr WHERE always_show = FALSE AND row_id BETWEEN 240 AND 279
UNION ALL
SELECT 'BR TRUE count' as description, COUNT(*) as count FROM variable_mapping_br WHERE always_show = TRUE AND row_id BETWEEN 310 AND 417
UNION ALL
SELECT 'BR FALSE count' as description, COUNT(*) as count FROM variable_mapping_br WHERE always_show = FALSE AND row_id BETWEEN 310 AND 417;